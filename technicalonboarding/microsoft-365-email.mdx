...
<Steps>
  ...
  <Step title="Add Members to Security Groups" stepNumber={5}>
    ...
    For detailed instructions on how to add members to these security groups, please refer to our guide: https://ravical.mintlify.app/technicalonboarding/securitygroups
  </Step>
