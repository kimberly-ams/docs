...
# How to configure Microsoft 365 Email and Calendar Access?

Connecting your Microsoft 365 environment to Ravical requires admin permissions and happens through a multi-step onboarding process. Here's how to complete the setup:
...
<Steps>
  <Step title="Step 0: Initiate the Microsoft 365 Setup" iconType="regular" stepNumber={0}>
  ...
  <Step title="Step 1: Grant Microsoft Graph Access">
  ...
  <Step title="Step 2: Accept Application Consent">
  ...
  <Step title="Step 3: Grant Exchange Online Access">
  ...
  <Step title="Step 4: Configure Exchange Online Resources">
  ...
  <Step title="Step 5: Add Members to Security Groups">
  ...
  <Step title="Step 6: Verify Completion">
